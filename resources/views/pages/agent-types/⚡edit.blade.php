...
new #[Title('Edit Agent Type')] #[Layout('layouts.app')] class extends Component {
    ...
    public function mount(): void
    {
        ...
        $this->default_model = $this->agentType->default_model ?? '';
        $this->default_provider = $this->agentType->default_provider ?? '';
        $this->default_temperature = $this->agentType->default_temperature !== null ? (string) $this->agentType->default_temperature : '';
        $this->default_max_steps = $this->agentType->default_max_steps !== null ? (string) $this->agentType->default_max_steps : '';
        $this->default_max_tokens = $this->agentType->default_max_tokens !== null ? (string) $this->agentType->default_max_tokens : '';
        $this->default_timeout = $this->agentType->default_timeout !== null ? (string) $this->agentType->default_timeout : '';
    }
